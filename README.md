...
Student ID: 21B030129
Student Fullname: Assylkhanov Aibek Almasovich
...
3. There are two inputs in the "New task" modal window: "Title" and "Summary". = 10 points
   ...
   3.5 Now, add the "Deadline" field, which will be a Date input. For instance, this Task is due to 25th of Decembet. Also, add related sorting buttons: "Sort by deadline" = 2 points
